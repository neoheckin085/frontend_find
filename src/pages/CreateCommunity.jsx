...
const CreateCommunity = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity style={styles.selectButton} onPress={() => setShowOwnerModal(true)}>
        <Text style={styles.selectButtonText}>
          {selectedOwner ? `Owner: ${selectedOwner.name}` : 'Select Owner'}
        </Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.selectButton} onPress={() => setShowMembersModal(true)}>
        <Text style={styles.selectButtonText}>
          {selectedMembers.length > 0 ? `Selected Members: ${selectedMembers.length}` : 'Select Members'}
        </Text>
      </TouchableOpacity>
