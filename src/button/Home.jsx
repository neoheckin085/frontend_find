// taruh di D:\find\frontend_find\src\button\Home.jsx
          ...
          <View style={styles.cardHeader}>
            <Image 
              ...
              onError={(error) => {
                ...
                console.log('Failed image path:', post.community?.gambar);
                console.log('Constructed URL:', getImageUrl(post.community?.gambar));
              }}
            />
